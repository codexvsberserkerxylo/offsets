...
namespace Offsets
{
    inline constexpr const char* LiveChannel = "version-9377ee10133e4be3";
    ...
    namespace Luau
    {
        ...
        //const uintptr_t luaC_step2 = REBASE(0x1dd04e0); does NOT look accurate so commented out (its print)
    ...
    namespace Task // ill verify myself in ida soon (i never did!)
    {
